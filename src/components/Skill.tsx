  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        src={skill.image.url}
        className="rounded-full border border-gray-500 bg-white object-cover w-12 h-12 md:w-16 md:h-16 group-hover:grayscale transition duration-300 ease-in-out"
        loading="lazy"
      />
      <div
